    ...
    while (true)
    {
        ...
        if (pose_msg != NULL)
        {
            ...
            if((T - last_t).norm() > SKIP_DIS)
            {
                ...
                printf("loop_closure_time: %f \n", loop_closure_time); 

                std::ofstream outFile("output/loop_closure_time.txt", std::ios::app);
                outFile << loop_closure_time << std::endl;
            outFile.close();
...
int main(int argc, char **argv)
{
    ...
    std::ofstream outFile("output/loop_closure_time.txt");
    outFile.close();
